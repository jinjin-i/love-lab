...
function AdContent() {
  ...
  return (
    <>
      ...
      <div style={{ flex: 1, padding: '32px 24px 5rem', display: 'flex', flexDirection: 'column', gap: 20 }}>
        <div style={{ textAlign: 'center', padding: '16px 0 8px' }}>
          ...
          <div style={{ fontSize: 13.5, color: 'rgba(240,234,216,0.5)', lineHeight: 1.7 }}>
            아래 배너를 클릭하면<br />결과를 바로 볼 수 있어요 🔮
          </div>
        </div>

        {/* 쿠팡 광고 링크 배너 */}
        <a href="https://coupa.ng/cgTsq3" target="_blank" rel="noreferrer"
          onClick={() => setAdClicked(true)}
          style={{ display: 'block', textDecoration: 'none' }}>
          <div style={{
            borderRadius: 18, border: '1px solid rgba(201,168,76,0.3)',
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 12, color: 'rgba(240,234,216,0.45)', lineHeight: 1.5 }}>클릭 후 결과 보기 버튼이 활성화돼요</div>
            </div>
